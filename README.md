code snippet for JS/Bun way of getting the tail end of a file with specified number of lines

```
async function getFileTail(filePath: string, linesToRead: number): Promise<string[]> {
